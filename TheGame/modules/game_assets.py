...
class GameAssets(object):
    ...
    def load_assets(self):
        ...
        self.create_image_asset("img_dark_matter_2", "images/dark_matter_2.png", True)
        self.create_image_asset("img_dark_matter_revealed", "images/dark_matter_revealed.png", True)
