...
class GameAssets(object):
    ...
    def load_assets(self):
        ...
        self.create_image_asset("img_bullet_player_s1", "images/bullet_player_s1.png", True)
        self.create_image_asset("img_bullet_player_s2", "images/bullet_player_s2.png", True)
        self.create_image_asset("img_bullet_player_s3", "images/bullet_player_s3.png", True)
        ...
        self.create_image_asset("img_bullet_boss_4_s1", "images/bullet_boss_4_s1.png", True)
        self.create_image_asset("img_bullet_boss_4_s2", "images/bullet_boss_4_s2.png", True)
        self.create_image_asset("img_bullet_boss_3_s1", "images/bullet_boss_3_s1.png", True)
        self.create_image_asset("img_bullet_boss_3_s2", "images/bullet_boss_3_s2.png", True)
        self.create_image_asset("img_bullet_boss_3_s3", "images/bullet_boss_3_s3.png", True)
        self.create_image_asset("img_bullet_boss_3_s4", "images/bullet_boss_3_s4.png", True)
        self.create_image_asset("img_bullet_boss_3_s5", "images/bullet_boss_3_s5.png", True)
        self.create_image_asset("img_bullet_boss_3_s6", "images/bullet_boss_3_s6.png", True)
        self.create_image_asset("img_bullet_boss_3_s7", "images/bullet_boss_3_s7.png", True)
        self.create_image_asset("img_bullet_boss_2_s1", "images/bullet_boss_2_s1.png", True)
        self.create_image_asset("img_bullet_boss_2_s2", "images/bullet_boss_2_s2.png", True)
        ...
        self.create_image_asset("img_bkg_2_1", "images/bkg_2_1.png", True)
        self.create_image_asset("img_bkg_2_2", "images/bkg_2_2.png", True)
        ...
        self.create_sound_asset("snd_default_bkg_2", "sounds/PatreonGoalRewardLoops-Track10-Layer_04.wav", True)
        ...
        # self.create_sound_asset("snd_powerup_spawn", "sounds/Powerup_spawn_657938__matrixxx__scifi-popup-warning-notice-or-note.wav", False)
        self.create_sound_asset("snd_powerup_spawn", "sounds/Powerup_spawn_569679__marokki__plop-effect.wav", False)
        # self.create_sound_asset("snd_powerup_pickup", "sounds/Powerup_pickup_523649__matrixxx__powerup-07.wav", False)
        self.create_sound_asset("snd_powerup_pickup", "sounds/Powerup_pickup_325805__wagna__collect.wav", False)
        ...
        # self.create_sound_asset("snd_darkmatter_collide", "sounds/Hit_Darkmatter_455215__matrixxx__cartoon-stunned-02.wav", False)
        self.create_sound_asset("snd_darkmatter_collide", "sounds/Hit_Darkmatter_95952__tmokonen__zap.wav", False)